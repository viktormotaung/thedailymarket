...
class CreditEditForm(forms.Form):
    ...
    account_type = forms.ChoiceField(choices=Client.ACCOUNT_TYPES, label="Account Type")
    credit_status = forms.ChoiceField(choices=Client.CREDIT_STATUS, label="Credit Status")
    ...
    def __init__(self, *args, **kwargs):
        ...
        for name, field in self.fields.items():
            if isinstance(field.widget, (forms.Select,)):
                ...
                field.widget.attrs.update({"class": (classes + " form-control").strip()})
