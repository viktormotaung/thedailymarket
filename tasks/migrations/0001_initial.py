    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('SUPPORT', 'Support'), ('ACCOUNTS', 'Accounts'), ('SALES', 'Sales'), ('COMPLIANCE', 'Compliance'), ('PRODUCT', 'Product'), ('OPERATIONS', 'Operations')], db_index=True, default='SUPPORT', max_length=20)),
